-- downloaded from http://gdeltproject.org/data/lookups/CAMEO.knowngroup.txt
...
INSERT INTO groupcode VALUES
  ...
  ( 'BTH', 'Baath Party' ),
  -- ( 'CEM', 'Common Market for Eastern and Southern Africa' ), -- key conflict
  -- ( 'CEM', 'Monetary and Economic Community of Central Africa' ), -- key conflict
  ( 'CEM', 'Monetary and Economic Community of Central Africa/Monetary and Economic Community of Central Africa*' ), -- resolving above key conflict
  ...
  -- ( 'WTO', 'World Trade Organization (WTO)' ), -- duplicate
  ( 'XFM', 'Oxfam' );
