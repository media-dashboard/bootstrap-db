-- download from http://data.gdeltproject.org/documentation/CAMEO.Manual.1.1b3.pdf
CREATE TABLE eventcode (
  code text PRIMARY KEY ,
  label text
);

INSERT INTO eventcode VALUES
  ...
  ( '12', 'Reject' ),
    ...
    ( '124', 'Refuse to yield' ),
      ...
      ( '1242', 'Refuse to ease political dissent' ),
  ...
  ( '14', 'Protest' ),
    ...
    ( '143', 'Conduct strike or boycott' ),
      ( '1431', 'Conduct strike or boycott leadership change' ),
      ( '1432', 'Conduct strike or boycott policy change' ),
      ( '1433', 'Conduct strike or boycott rights' ),
      ( '1434', 'Conduct strike or boycott change in institutions, regime' ),
  ...
  ( '19', 'Fight' ),
    ...
    ( '195', 'Employ aerial weapons' ),
      ...
      ( '1952', 'Employ remotely poloted aerial munitions' ),
    ( '196', 'Violate ceasefire' ),

  ( '20', 'Use unconventional mass violence' ),
    ( '200', 'Use unconventional mass violence' ),
    ( '201', 'Engage in mass expulsion' ),
    ( '202', 'Engage in mass kilings' ),
